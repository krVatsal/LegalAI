...
export default function AnalysisPage() {
    ...
    const fetchLegalAnalysisResults = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/analysis/results/${fileId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const performLegalAnalysis = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/analysis/analyze/${fileId}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
    ...
    const generateSummary = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/analysis/summary/${fileId}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
    ...
    const extractLegalEntities = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/analysis/entities/${fileId}`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
    ...
    const fetchAnalysisData = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/ocr/result/${fileId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const loadMoreChunks = async () => {
        try {
            ...
            const response = await fetch(`https://legalai-xx7y.onrender.com/api/ocr/chunks/${fileId}?page=${currentPage + 1}&limit=10`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const downloadPDF = (content, fileName, type = 'analysis') => {
        const token = localStorage.getItem('token');
        fetch('https://legalai-xx7y.onrender.com/api/document/generate-pdf', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
