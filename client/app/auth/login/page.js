...
export default function Login() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const response = await fetch('https://legalai-1-ete1.onrender.com/api/auth/send-otp', {
        method: 'POST',
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await fetch('https://legalai-1-ete1.onrender.com/api/auth/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleGoogleLogin = () => {
    ...
    window.open(
      'https://legalai-1-ete1.onrender.com/api/auth/google',
      'Google Login',
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 border border-gray-700 rounded-lg shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
