...
export default function Login() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const response = await fetch('https://legalai-xx7y.onrender.com/api/auth/send-otp', {
        method: 'POST',
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await fetch('https://legalai-xx7y.onrender.com/api/auth/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleGoogleLogin = () => {
    ...
    window.open(
      'https://legalai-xx7y.onrender.com/api/auth/google',
      'Google Login',
